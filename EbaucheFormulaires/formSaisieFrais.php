...
<div name="droite" style="float:left;width:80%;">
	...
	<form name="formSaisieFrais" method="post" action="enregSaisieFrais.php">
		...
		<label class="titre">PERIODE D'ENGAGEMENT :</label>
			<label style="float:left;">Mois (2 chiffres) : </label><input type="text" size="4" name="FRA_MOIS" class="zone" value="<?php echo $mois; ?>" />
			<label style="float:left;">&nbsp;Année (4 chiffres) : </label><input type="text" size="4" name="FRA_AN" class="zone" value="<?php echo $annee;?>" />
